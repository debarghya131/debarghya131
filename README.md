...
|---------|-------------|------|:----:|:----:|
| [**MonkMode**](https://monkmode.debarghya.org) | AI self-improvement platform with habit tracking, heatmaps, goal analytics, and LLM coaching engine | React · Node.js · MongoDB · Groq API · Framer Motion | [GitHub](https://github.com/debarghya131/MonkMode) | [Demo](https://monkmode.debarghya.org) |
| [**Actual**](https://actual.debarghya.org) | AI finance platform with receipt scanning, budget tracking, Kubera AI assistant, and monthly reports | Next.js · TypeScript · PostgreSQL · Prisma · Gemini API | [GitHub](https://github.com/debarghya131/Actual) | [Demo](https://actual.debarghya.org) |
| [**InstaMeet**](https://instameet.debarghya.org) | Video conferencing platform with WebRTC P2P streaming, Socket.IO signaling, screen sharing, and live chat | React · Node.js · WebRTC · Socket.IO · MongoDB | [GitHub](https://github.com/debarghya131/InstaMeet) | [Demo](https://instameet.debarghya.org) |
...
| [**Zerodha Clone**](https://zerodha-clone-kohl.vercel.app/) | Full-stack stock trading platform inspired by Zerodha featuring JWT authentication, protected dashboard, portfolio analytics, holdings, watchlist, and order placement | React · Node.js · Express.js · MongoDB · JWT · Chart.js | [GitHub](https://github.com/your-username/zerodha-clone) | [Demo](https://zerodha-clone-kohl.vercel.app/) |
