...
| --------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- | --------------------------------------------------------- | :----------------------: | :-----------------------------------------: |
| [**MonkMode**](https://monkmode.debarghya.org)            | AI self-improvement platform with habit tracking, heatmaps, goal analytics, and LLM coaching engine       | React · Node.js · MongoDB · Groq API · Framer Motion      | [GitHub](YOUR_REPO_LINK) |    [Demo](https://monkmode.debarghya.org)   |
| [**Actual**](https://actual.debarghya.org)                | AI finance platform with receipt scanning, budget tracking, Kubera AI assistant, and monthly reports      | Next.js · TypeScript · PostgreSQL · Prisma · Gemini API   | [GitHub](YOUR_REPO_LINK) |     [Demo](https://actual.debarghya.org)    |
| [**InstaMeet**](https://instameet.debarghya.org)          | Video conferencing platform with WebRTC P2P streaming, Socket.IO signaling, screen sharing, and live chat | React · Node.js · WebRTC · Socket.IO · MongoDB            | [GitHub](YOUR_REPO_LINK) |   [Demo](https://instameet.debarghya.org)   |
| [**PippoAI**](https://pippoai.debarghya.org)              | AI career coach with resume builder, PDF export, cover letter generation, and mock interviews             | Next.js 15 · React 19 · PostgreSQL · Gemini API · Inngest | [GitHub](YOUR_REPO_LINK) |    [Demo](https://pippoai.debarghya.org)    |
| [**SkillBridge**](https://skillbridge.debarghya.org)      | Two-sided marketplace connecting Tier-2/3 students with MSMEs via TrustScore, gigs, and escrow payments   | React · Node.js · MongoDB · GitHub Actions                | [GitHub](YOUR_REPO_LINK) |  [Demo](https://skillbridge.debarghya.org)  |
| [**PippoGPT**](https://pippo.debarghya.org)               | Full-stack ChatGPT-style assistant with persistent threads, markdown rendering, and Groq AI integration   | React · Node.js · MongoDB · Groq SDK · Clerk              | [GitHub](YOUR_REPO_LINK) |     [Demo](https://pippo.debarghya.org)     |
| [**Zerodha Clone**](https://zerodha.debarghya.org)        | Stock trading platform with JWT authentication, protected dashboard, watchlist, and Chart.js analytics    | React · Node.js · MongoDB · JWT · Chart.js                | [GitHub](YOUR_REPO_LINK) |    [Demo](https://zerodha.debarghya.org)    |
| [**Travel Diaries**](https://traveldiaries.debarghya.org) | MERN travel memory platform with community feed, user profiles, and full CRUD management                  | React · Redux Toolkit · Node.js · MongoDB · Clerk         | [GitHub](YOUR_REPO_LINK) | [Demo](https://traveldiaries.debarghya.org) |
| [**SnipLink**](https://sniplink.debarghya.org)            | Fast URL shortener with custom short links, duplicate protection, and instant redirects                   | Next.js · MongoDB · Tailwind CSS                          | [GitHub](YOUR_REPO_LINK) |    [Demo](https://sniplink.debarghya.org)   |
...
<div align="center">
  <img src="https://streak-stats.demolab.com?user=debarghya131&theme=tokyonight&hide_border=true" width="60%" />
</div>
